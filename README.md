...
2. Download the latest release ZIP file (e.g., `NepuShiro-BepisModSettings-0.0.3.zip`) from the [Releases](https://github.com/ResoniteModding/BepisModSettings/releases) page.
